...
public class Application {
  ...
  // Registering problematicCustomizer bean will result in AssertionError when closing connection span
  // in TraceJdbcEventListener.onAfterConnectionClose
  //
  ...
  //  ...
  @Bean
  public CorrelationScopeCustomizer problematicCustomizer() {
    return builder -> builder.add(SingleCorrelationField.newBuilder(BaggageField.create("aCustomField"))
        .flushOnUpdate() // setting flushOnUpdate seems to be the culprit
        .build());
  }
